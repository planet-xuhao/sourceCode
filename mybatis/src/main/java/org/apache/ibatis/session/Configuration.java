 ...
 */
/**
 * 配置，里面好多配置项,将mybatis.config配置文件封装为一个对象
 * 
 */
public class Configuration {
  ...
  public Configuration() {
    ...
    // 使用示例：<transactionManager type="JDBC"/>
    // 等同于：<transactionManager type="org.apache.ibatis.transaction.jdbc.JdbcTransactionFactory.class"/>
